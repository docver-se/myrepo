...
function prepareRemotePatterns() {
  let patterns = [
    ...
    { protocol: "https", hostname: "assets.docver.se" },
    { protocol: "https", hostname: "cdn.docver.se" },
    ...
    { protocol: "https", hostname: "www.docver.se" },
    { protocol: "https", hostname: "app.docver.se" },
    // useragent img
